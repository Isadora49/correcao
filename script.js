...
btnDownload.addEventListener('click', async () => {
    try {
        ...
        for (let i = 0; i < TOTAL_FIELDS; i++) {
            ...
            // --- MODIFICAÇÃO AQUI: CORREÇÃO DA TROCA ENTRE C4 E C7 ---
            // Invertemos a atribuição dos nomes: o índice 3 (C4) vira 'res2' e o índice 6 (C7) vira 'res'
            let name = (i === 3) ? 'res2' : (i === 6) ? 'res' : `c${i+1}`;
            let f;
